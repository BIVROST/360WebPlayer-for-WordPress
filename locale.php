...
$strings='tinyMCE.addI18n("'._WP_Editors::$mce_locale.'.bivrost-360webplayer", '.json_encode(array(
	...
	'label_width' => __('Widget width in css units (px, %, etc),\nleave empty for default', 'bivrost-360webplayer'),
	'label_height' => __('Widget height in css units (px, %, etc),\nleave empty for default', 'bivrost-360webplayer'),
